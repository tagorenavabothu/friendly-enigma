...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["name"])) {
      ...
      if($_FILES['userfile']['size'] > 19137299) { //10 MB (size is also in bytes)
        // File too big -----
            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="MAX_FILE_SIZE" value="19137299" > <span class="attachements_hint">Please attach supporting documents or videos (Max size: 20MB)</span> <span><?php echo "".$fileuploadErr;?></span> <input class="form-control" name="userfile" type="file" accept=
